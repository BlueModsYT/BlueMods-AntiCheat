    ...
    adminCategories: [
        ...
        },
        {
            ...
            commands: [
                ...
                "§7> §a!cmdtoggle ${main.enabledisable} <§acommand§7> §7- §3allows you to enable or disable a command. §7[§aMODULE§7]",
                ...
                "§7> §a!chatdisplay ${main.enabledisable} §7- §3enable or disable the chatdisplay into default mojang chat. §7[§aMODULE§7]",
                "§7> §a!rank ${main.addremove} §7<§arank§7> §7[§gcolor§7] ${main.player} §7- §3add rank(s) to player.",
                "§7> §a!chatconfig ${main.enabledisable} §7<§6module§7> §7- §3enable or disable a boolean chat configuration option.",
